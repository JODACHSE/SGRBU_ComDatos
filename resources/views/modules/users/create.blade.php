                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('identification_number') is-invalid @enderror"
                                    id="identification_number" name="identification_number" value="{{ old('identification_number') }}" required>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('campus_program_id') is-invalid @enderror"
                                    ...
                                    <option value="{{ $campusProgram->id }}" {{ old('campus_program_id') == $campusProgram->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('academic_status') is-invalid @enderror"
                                    ...
                                    <option value="activo" {{ old('academic_status') == 'activo' ? 'selected' : '' }}>Activo</option>
                                    <option value="baja temporal" {{ old('academic_status') == 'baja temporal' ? 'selected' : '' }}>Baja Temporal</option>
                                    <option value="baja permanente" {{ old('academic_status') == 'baja permanente' ? 'selected' : '' }}>Baja Permanente</option>
                                    <option value="condicional" {{ old('academic_status') == 'condicional' ? 'selected' : '' }}>Condicional</option>
                                    <option value="egresado" {{ old('academic_status') == 'egresado' ? 'selected' : '' }}>Egresado</option>
                                </select>
